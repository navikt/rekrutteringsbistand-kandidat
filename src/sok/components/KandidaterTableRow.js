            ...
            <div>
                <div className="panel border--top--thin">
                    <Row>
                        ...
                        <Column xs="4" md="4">
                            <Normaltekst>{this.props.cv.utdanning[0] ? this.props.cv.utdanning[0].nusKodeGrad : ''}</Normaltekst>
                        </Column>
                        <Column xs="3" md="3">
                            <Normaltekst>{this.props.cv.yrkeserfaring[0] ? this.props.cv.yrkeserfaring[0].styrkKodeStillingstittel : ''}</Normaltekst>
                        </Column>
