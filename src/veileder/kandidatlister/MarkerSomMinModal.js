        ...
        {stillingsId ?
            <div>
                <Normaltekst className="blokk-s">
                    Kandidatlisten er knyttet til en stilling. Hvis du markerer stillingen som din, blir du eier av stillingen og listen.
                    Du vil ha mulighet til å redigere stillingen, endre status, dele kandidater med arbeidsgiver og sende e-post til kandidatene.
                </Normaltekst>
            ...
            : <div>
                <Normaltekst className="blokk-m">
                    Hvis du markerer kandidatlisten som din, blir du eier av listen.
                    Du vil da ha mulighet til å endre status, dele kandidater med arbeidsgiver og sende e-post til kandidatene.
                </Normaltekst>
                <div>
