...
const UtdanningSearch = ({ ...props }) => {
    const { search, removeUtdanning, fetchTypeAheadSuggestions, selectTypeAheadValue, checkUtdanningsniva,
        uncheckUtdanningsniva, utdanninger, typeAheadSuggestionsUtdanning, utdanningsniva, clearTypeAheadUtdanning,
        visManglendeArbeidserfaringBoks, totaltAntallTreff, visAlertFaKandidater, skjulUtdanning,
        panelOpen, togglePanelOpen, visIngenUtdanning } = props;
    return (
